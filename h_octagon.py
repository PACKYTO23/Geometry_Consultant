...
SYMMETRY_ROTATION = DEGREES / SIDES  # 45°
INTERNAL_ANGLE = SEMICIRCLE - SYMMETRY_ROTATION  # 135°
HALF_ANGLE_EQUAL_TRIANGLES = DEGREES / (2 * SIDES)  # 22.5°


def side_length():
    """Returns the results of the 5 properties left given the side length."""
    s_length = float(input(f"Enter the length of the {O}'s side:\n"))
...
def apothem_icr_length():
    ...
    ap_length = float(input(f"Enter the length of the {O}'s apothem or inscribed circle radius:\n"))
...
def perimeter_length():
    ...
    p_length = float(input(f"Enter the length of the {O}'s perimeter:\n"))
...
def area_surface():
    ...
    a_surface = float(input(f"Enter the surface of the {O}'s area:\n"))
...
def circumradius_length():
    ...
    ccr_length = float(input(f"Enter the length of the {O}'s circumscribed circle radius:\n"))
...
def calculate_octagon(characteristic):
